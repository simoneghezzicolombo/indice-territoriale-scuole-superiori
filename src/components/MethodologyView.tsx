...
+ 10% tenuta universitaria`}</pre>
          ...
          <section className="space-y-3 pt-4 border-t border-[#bdc9c7]/20">
            <h3 className="font-sans font-bold text-xs uppercase tracking-wider text-[#031f27]">Quali scuole sono incluse</h3>
            <p className="font-sans text-xs text-[#3e4947] leading-relaxed">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-yellow-50/55 rounded-2xl border border-yellow-200 p-6 space-y-3">
            <div className="flex items-center gap-2 text-amber-800">
              ...
              <h4 className="font-sans font-bold text-xs">Limiti principali</h4>
            </div>
